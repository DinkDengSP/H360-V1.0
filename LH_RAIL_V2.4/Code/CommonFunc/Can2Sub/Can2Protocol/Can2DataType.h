...
typedef enum CAN2_CHANNEL
{
    ...
    //轨道下位机板信道
    CAN2_RAIL_CHANNEL_PUSHIN1   = 19,
    CAN2_RAIL_CHANNEL_PUSHIN2   = 20,
    CAN2_RAIL_CHANNEL_PUSHOUT1  = 21,
    CAN2_RAIL_CHANNEL_PUSHOUT2  = 22,
    CAN2_RAIL_CHANNEL_TRANS     = 23,
    CAN2_RAIL_CHANNEL_HAND      = 24,
    CAN2_RAIL_CHANNEL_BAR_SCAN  = 26,
    CAN2_RAIL_CHANNEL_PARAM     = 27,
    CAN2_RAIL_CHANNEL_COMPLEX   = 25,
}CAN2_CHANNEL;
...
typedef enum CAN2_SUB_DATA_FLAG
{
    ...
    CAN2_SUB_DATA_IAP_FLAG                  = 0X0006,//IAP符号
    CAN2_SUB_DATA_SOFTVERSION               = 0X0007,//软件版本
    CAN2_SUB_DATA_MODULE_MOTOR              = 0X0008,//模块电机运转数据标识
    //轨道板上传数据标识
    CAN2_SUB_DATA_RAIL_PUSHIN1_EXIST        = 0X8000,//进样1传感器状态
    CAN2_SUB_DATA_RAIL_PUSHIN2_EXIST        = 0X8001,//进样2传感器状态
    CAN2_SUB_DATA_RAIL_HAND_RACK_EXIST      = 0X8002,//机械手上试管架状态
    CAN2_SUB_DATA_RAIL_PUSHOUT1_INDEX       = 0X8003,//出样1当前位置序号,因为出样可以推进多次不回零
    CAN2_SUB_DATA_RAIL_PUSHOUT2_INDEX       = 0X8004,//出样2当前位置序号,因为出样可以推进多次不回零
    CAN2_SUB_DATA_RAIL_HAND_STATE           = 0X8005,//机械手上当前状态,包含方向和手上是否有架子
    CAN2_SUB_DATA_RAIL_APP_PARAM_READ       = 0X8006,//读取APP参数
    CAN2_SUB_DATA_RAIL_BARCODE_GENERAL      = 0X8007,//条码数据,单次扫描,不知道是架子还是试管
    CAN2_SUB_DATA_RAIL_BARCODE_RACK_TUBE    = 0X8008,//条码数据,组合扫描,带有特定的代码规则
    CAN2_SUB_DATA_RAIL_RAIL_POS             = 0X8009,//轨道当前的位置
    CAN2_SUB_DATA_RAIL_PUSHIN_EXIST         = 0X800A,//进样1和2传感器组合状态
}CAN2_SUB_DATA_FLAG;
