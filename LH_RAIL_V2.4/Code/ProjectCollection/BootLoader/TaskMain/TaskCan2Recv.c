...
**Author: DengXiaoJun
**Date: 2020-07-01 18:29:34
**LastEditors: DengXiaoJun
**LastEditTime: 2020-07-02 18:13:52
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
#pragma pack(8)
//任务堆栈
CPU_STK stackBufferTaskCan2Recv[STK_SIZE_TASK_CAN2_RECV]@".dtcm_ram";
#pragma pack()

//任务控制块
OS_TCB tcbTaskCan2Recv@".dtcm_ram";
...
void OS_Can2ReceiveDataCallFunc(MCU_CAN_RECV_DAT* rxMsg)
{
    ...
    OS_ERR err;
    //将申请的数据转发到协议处理线程
    OSTaskQPost((OS_TCB *)&tcbTaskCan2Recv, //向协议处理线程发送消息
                (void *)rxMsg,
