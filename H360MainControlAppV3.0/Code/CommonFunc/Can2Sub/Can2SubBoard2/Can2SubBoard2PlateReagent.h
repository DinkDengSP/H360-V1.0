 ...
 *FilePath: \Code\CommonFunc\Can2SubBoard2\Can2SubBoard2PlateReagent.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
 *ModifyRecord5:    
******************************************************************/
#ifndef __CAN2_SUB_BOARD2_PLATE_REAGENT_H_
#define __CAN2_SUB_BOARD2_PLATE_REAGENT_H_
...
typedef enum PLATE_REAGENT_OFFSET
{
    ...
    PLATE_REAGENT_OFFSET_QR_RFID            = 0X07,//试剂盘旋转到RFID位置偏移
