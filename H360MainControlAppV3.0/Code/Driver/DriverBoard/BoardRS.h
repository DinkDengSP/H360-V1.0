 ...
 *Author: DengXiaoJun
 *Date: 2020-06-19 09:10:13
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-06-19 13:42:53
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
{
    BOARD_RS1_UART3_VERSION0,//六针 带供电,日志端口
    BOARD_RS1_UART3_VERSION1,//六针 带供电,RFID端口
    BOARD_RS2_UART1_VERSION0,//四针 不带供电,日志端口
    BOARD_RS2_UART1_VERSION1,//四针 不带供电,暂时未配置
    BOARD_RS3_UART2,//六针,带供电,条码枪串口
    BOARD_RS4_UART6,//四针,不带供电,温控端口
}BOARD_RS_SERIAL;

#define QR_BAR_SCAN_PORT    BOARD_RS3_UART2
#define ACTION_DEBUG_PORT   BOARD_RS1_UART3_VERSION0
