...
**LastEditTime: 2021-08-11 13:46:45
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
const CAN1_DISPATCH_UNIT can1DispatchArray[] = {
    ...
    {CAN1_CMD_ACK                                                           ,       &tcbTaskBoardIap },//升级结束
    {CAN1_CMD_TEST_FLOW_CMD_PROGRAM_JUMP                                    ,       &tcbTaskBoardIap },//强制跳转
    {CAN1_CMD_TEST_FLOW_CELL_TEST_PARAM                                     ,       &tcbTaskBoardIap },//测试参数,返回ACK响应就可以
};
//转发数组的长度
