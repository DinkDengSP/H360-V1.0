 ...
 *LastEditTime: 2020-07-04 15:40:12
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
//输出任务调试讯息
#define SystemDebugShowMsgStart(msgStr,paramStr,paramVal1,paramVal2,paramVal3,paramVal4,paramVal5)       MCU_Uart3PrintfVersion0("%s%s - %d - %d - %d - %d - %d\r\n",(uint8_t*)msgStr, (uint8_t*)paramStr,paramVal1,paramVal2,paramVal3,paramVal4,paramVal5)                                                                                                           
//输出任务结束讯息
#define SystemDebugShowMsgEnd(endStr,userErrorCode)                                                      MCU_Uart3PrintfVersion0("%s - 0X%08X\r\n",endStr,userErrorCode)
//输出错误信息
#define SystemDebugShowMsgError(errorCode)                                                               MCU_Uart3PrintfVersion0("!!Action Error Func : %s , Line : %d , ErrorCode : 0X%08X\r\n", __FUNCTION__,__LINE__,errorCode)
#else
//不输出信息调试
