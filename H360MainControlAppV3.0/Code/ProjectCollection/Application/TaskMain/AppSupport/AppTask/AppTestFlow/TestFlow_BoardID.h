 ...
 *Author: DengXiaoJun
 *Date: 2020-01-10 11:55:57
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-01-10 13:18:57
 *FilePath: \DeviceMainApplication\TaskMain\AppLogicSupport\AppTask\AppTestFlow\TestFlow_boardID.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
 ...
 *
 *  Subsystem:   TestFlow
 *  File:        TestFlow_boardID.h
 *  Author:      WWZHOU
 *  Description: Command for can bus.
 *********************************************************************/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __TESTFLOW_BOARDID_H__
#define __TESTFLOW_BOARDID_H__
...
/* Exported constants --------------------------------------------------------*/
#define TESTFLOW_CELL_1_NMBR                                (0)     // Cell 1
#define TESTFLOW_CELL_2_NMBR                                (1)     // Cell 2
#define TESTFLOW_CELL_3_NMBR                                (2)     // Cell 3
#define TESTFLOW_CELL_4_NMBR                                (3)     // Cell 4
#define TESTFLOW_CELL_ISE_NMBR                              (4)     // ise
#define TESTFLOW_CELL_PLATFORM_NMBR                         (5)     // platform
   
#define TESTFLOW_CELL_NMBR                                  (TESTFLOW_CELL_1_NMBR)
