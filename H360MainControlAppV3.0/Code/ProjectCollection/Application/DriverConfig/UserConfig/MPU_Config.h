...
//ITCM的MPU配置地址和长度
#define ITCM_SRAM_NBR              MPU_REGION_NUMBER9
#define ITCM_SRAM_BASE_ADDR        0X00000000
#define ITCM_SRAM_LENGTH           MPU_REGION_SIZE_64KB

//SRAM IS62的MPU配置地址和长度
#define EXT_IS62_SRAM_NBR          MPU_REGION_NUMBER8
