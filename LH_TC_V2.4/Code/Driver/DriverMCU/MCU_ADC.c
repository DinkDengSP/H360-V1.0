...
void MCU_ADC_Init(void)
{
    ...
    MCU_PortInit(MCU_PIN_A_0, GPIO_Mode_AN, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_25MHz);
    ...
    MCU_PortInit(MCU_PIN_C_4, GPIO_Mode_AN, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_25MHz);
    MCU_PortInit(MCU_PIN_C_5, GPIO_Mode_AN, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_25MHz);
