...
**LastEditTime: 2020-06-23 18:04:17
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
void MCU_CAN1_Init(MCU_CAN_BAUD baud,uint8_t boardID,MCU_CAN_RecvIntProcFuncPtr callBack)
{
    ...
    //电压监控
    MCU_PortInit(MCU_PIN_A_8, GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_UP, GPIO_Speed_100MHz);
...
void CAN1_RX0_IRQHandler(void)
{
    ...
    {
        BoardSystemLedWrite(BOARD_LED_YELLOW,IO_SIGNAL_VALID);
        //溢出中断
