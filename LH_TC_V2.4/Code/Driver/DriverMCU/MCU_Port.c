...
//PORTG
static void MCU_PortInitG(uint16_t pinIndex, GPIOMode_TypeDef mode, GPIOOType_TypeDef oType, GPIOPuPd_TypeDef pupd, GPIOSpeed_TypeDef speed)
{
    GPIO_InitTypeDef GPIO_InitStructure;
    /**使能端口时钟 */
...
static void MCU_PortWriteSingleG(uint16_t pinIndex, BitAction value)
{
    if (Bit_RESET == value)
    {
...
static BitAction MCU_PortReadSingleG(uint16_t pinIndex)
{
    return (BitAction)GPIO_ReadInputDataBit(GPIOG, pinIndex);
}

//PORTH
static void MCU_PortInitH(uint16_t pinIndex, GPIOMode_TypeDef mode, GPIOOType_TypeDef oType, GPIOPuPd_TypeDef pupd, GPIOSpeed_TypeDef speed)
{
    GPIO_InitTypeDef GPIO_InitStructure;
    /**使能端口时钟 */
...
static void MCU_PortWriteSingleH(uint16_t pinIndex, BitAction value)
{
    if (Bit_RESET == value)
    {
...
static BitAction MCU_PortReadSingleH(uint16_t pinIndex)
{
    return (BitAction)GPIO_ReadInputDataBit(GPIOH, pinIndex);
}

//PORTI
static void MCU_PortInitI(uint16_t pinIndex, GPIOMode_TypeDef mode, GPIOOType_TypeDef oType, GPIOPuPd_TypeDef pupd, GPIOSpeed_TypeDef speed)
{
    GPIO_InitTypeDef GPIO_InitStructure;
    /**使能端口时钟 */
...
static void MCU_PortWriteSingleI(uint16_t pinIndex, BitAction value)
{
    if (Bit_RESET == value)
    {
...
static BitAction MCU_PortReadSingleI(uint16_t pinIndex)
{
