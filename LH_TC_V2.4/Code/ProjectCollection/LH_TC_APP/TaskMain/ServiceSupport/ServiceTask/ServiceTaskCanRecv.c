...
**Author: DengXiaoJun
**Date: 2020-01-16 19:59:02
**LastEditors: DengXiaoJun
**LastEditTime: 2020-07-06 11:09:16
**FilePath: \LH_TC_APP_V2.3\TaskMain\ServiceSupport\ServiceTask\ServiceTaskCanRecv.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
static const CAN_SLAVE_DISPATCH_CONFIG canSlaveDispatchConfigArray[CAN_PROTOCOL_BOARD_CHANNEL_MAX] = {
    ...
    {1      ,       &tcbServiceTaskSensor           },
    {2      ,       &tcbServiceTaskEnvir            },
    {3      ,       &tcbServiceTaskParam            },
    {4      ,       &tcbServiceTaskPlateReaction    },
    {5      ,       &tcbServiceTaskPlateReagent     },
    {6      ,       &tcbServiceTaskPlateWash        },
    {7      ,       NULL                            },
    {8      ,       NULL                            },
    {9      ,       NULL                            },
    {10     ,       NULL                            },
    ...
    {16     ,       NULL                            },
    {17     ,       NULL                            },
    {18     ,       &tcbServiceTaskDebugIAP         },//以上为系统服务任务,基础大同小异,以下为应用服务程序,各个大不相同
    {19     ,       &tcbAppTaskSystemMsg            },
    {20     ,       NULL                            },
    {21     ,       NULL                            },
    {22     ,       NULL                            },
    {23     ,       NULL                            },
