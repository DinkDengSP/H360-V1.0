...
/*使能参数检查*/
#define OS_CFG_ARG_CHK_EN               DEF_DISABLED             /* Enable (DEF_ENABLED) argument checking                                */

/*使能中断中调用系统API检查*/
#define OS_CFG_CALLED_FROM_ISR_CHK_EN   DEF_DISABLED             /* Enable (DEF_ENABLED) check for called from ISR                        */
...
#define OS_CFG_STAT_TASK_STK_CHK_EN     DEF_DISABLED             /*     Check task stacks (DEF_ENABLED) from the statistic task           */
