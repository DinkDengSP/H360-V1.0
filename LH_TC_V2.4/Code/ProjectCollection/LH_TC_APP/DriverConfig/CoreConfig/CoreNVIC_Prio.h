 ...
 *LastEditTime: 2020-06-23 18:18:05
...
//中断子优先级
#define MCU_DMA1_STREAM6_SUB_PRI            INT_SUB_PRI_2

//中断抢占优先级,DMA 串口2 接收
#define MCU_DMA1_STREAM5_PREE_PRI           INT_PRE_PRI_1
//中断子优先级
#define MCU_DMA1_STREAM5_SUB_PRI            INT_SUB_PRI_2
/************************************会调用系统内核函数的中断优先级********************************/
//中断优先级RX CAN
...
//中断子优先级
#define MCU_UART2_DMA_SUB_PRI               INT_SUB_PRI_2
