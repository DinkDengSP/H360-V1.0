...
{
    netStateSet.mainPortState = 0;
    netStateSet.debugPortState = 0;
...
//获取设置当前网卡芯片状态
uint8_t  TcpBaseUtilGetMainPortState(void)
{
    return netStateSet.mainPortState;
}
void TcpBaseUtilSetMainPortState(uint8_t portState)
{
    netStateSet.mainPortState = portState;
}

//获取设置当前网卡芯片状态
uint8_t  TcpBaseUtilGetDebugPortState(void)
{
    return netStateSet.debugPortState;
}
void TcpBaseUtilSetDebugPortState(uint8_t portState)
{
    netStateSet.debugPortState = portState;
}
