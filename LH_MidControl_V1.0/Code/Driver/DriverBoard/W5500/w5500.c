...
**LastEditTime: 2021-02-02 16:15:20
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
//这个是配置的
uint8 txsize[MAX_SOCK_NUM] = {8,8,0,0,0,0,0,0}; // tx buffer set K bytes
uint8 rxsize[MAX_SOCK_NUM] = {8,8,0,0,0,0,0,0}; // rx buffet set K bytes
