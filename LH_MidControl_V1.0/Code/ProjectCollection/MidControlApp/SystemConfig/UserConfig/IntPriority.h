 ...
 *Author: DengXiaoJun
 *Date: 2021-07-27 16:53:32
 *LastEditors: DengXiaoJun
 *LastEditTime: 2021-07-29 16:18:10
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
#define QSPI_SUB_PRIORITY                   NVIC_INT_SUB_PRI_1

//MDMA中断
#define MDMA_PREEMPT_PRIORITY               NVIC_INT_PRE_PRI_0
#define MDMA_SUB_PRIORITY                   NVIC_INT_SUB_PRI_2

//串口1发送 DMA中断
#define MCU_DMA1_STREAM0_PREE_PRI           NVIC_INT_PRE_PRI_0
#define MCU_DMA1_STREAM0_SUB_PRI            NVIC_INT_SUB_PRI_3

//串口6发送,DMA中断
#define MCU_DMA1_STREAM1_PREE_PRI           NVIC_INT_PRE_PRI_0
#define MCU_DMA1_STREAM1_SUB_PRI            NVIC_INT_SUB_PRI_3

/*******************************调用操作系统内核函数的中断**************************************/
//系统滴答定时器中断
#define CORE_SYSTICK_PREE_PRI               NVIC_INT_PRE_PRI_1
#define CORE_SYSTICK_SUB_PRI                NVIC_INT_SUB_PRI_0
...
#define CAN2_INT1_SUB_PRI                   NVIC_INT_SUB_PRI_0
...
#define CAN1_INT1_SUB_PRI                   NVIC_INT_SUB_PRI_1

//CAN时钟校准中断
#define CAN_CC_PREE_PRI                     NVIC_INT_PRE_PRI_2
#define CAN_CC_SUB_PRI                      NVIC_INT_SUB_PRI_2

//文件系统驱动 SDIO
#define SDIO_PREEMPT_PRIORITY               NVIC_INT_PRE_PRI_2
#define SDIO_SUB_PRIORITY                   NVIC_INT_SUB_PRI_3
...
#define MCU_UART2_SUB_PRI                   NVIC_INT_SUB_PRI_0

//串口3中断
#define MCU_UART3_PREE_PRI                  NVIC_INT_PRE_PRI_3
#define MCU_UART3_SUB_PRI                   NVIC_INT_SUB_PRI_0

//串口6中断
#define MCU_UART6_PREE_PRI                  NVIC_INT_PRE_PRI_3
#define MCU_UART6_SUB_PRI                   NVIC_INT_SUB_PRI_0
