...
#pragma pack(8)
//任务堆栈
uint64_t stackBufferAppTaskCanMsgCloud[STK_SIZE_APP_TASK_CAN_MSG_CLOUD/8]@".dtcm_ram2";
#pragma pack()
//任务的控制块
TX_THREAD tcbAppTaskCanMsgCloud@".dtcm_ram2";
//任务消息队列缓冲区,4字节对齐
#pragma pack(8)
uint32_t queueBufferAppTaskCanMsgCloud[LENGTH_QUEUE_APP_TASK_CAN_MSG_CLOUD]@".dtcm_ram2";
#pragma pack()
//任务消息队列控制块
TX_QUEUE queueAppTaskCanMsgCloud@".dtcm_ram2";
