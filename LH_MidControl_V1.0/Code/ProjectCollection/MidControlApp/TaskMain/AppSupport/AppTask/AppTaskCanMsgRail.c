...
#pragma pack(8)
//任务堆栈
uint64_t stackBufferAppTaskCanMsgRail[STK_SIZE_APP_TASK_CAN_MSG_RAIL/8]@".dtcm_ram2";
#pragma pack()
//任务的控制块
TX_THREAD tcbAppTaskCanMsgRail@".dtcm_ram2";
//任务消息队列缓冲区,4字节对齐
#pragma pack(8)
uint32_t queueBufferAppTaskCanMsgRail[LENGTH_QUEUE_APP_TASK_CAN_MSG_RAIL]@".dtcm_ram2";
#pragma pack()
//任务消息队列控制块
TX_QUEUE queueAppTaskCanMsgRail@".dtcm_ram2";
