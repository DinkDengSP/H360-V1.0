...
//任务堆栈
uint64_t stackBufferAppTaskTcpMsg[STK_SIZE_APP_TASK_TCP_MSG/8]@".dtcm_ram2";
//任务的控制块
TX_THREAD tcbAppTaskTcpMsg@".dtcm_ram2";
//任务消息队列缓冲区,4字节对齐
uint32_t queueBufferAppTaskTcpMsg[LENGTH_QUEUE_APP_TASK_TCP_MSG]@".dtcm_ram2";
//任务消息队列控制块
TX_QUEUE queueAppTaskTcpMsg@".dtcm_ram2";
