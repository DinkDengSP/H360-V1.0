...
#pragma pack(8)
//任务堆栈
uint64_t stackBufferAppTaskCanMsgImm[STK_SIZE_APP_TASK_CAN_MSG_IMM/8]@".dtcm_ram";
#pragma pack()
//任务的控制块
TX_THREAD tcbAppTaskCanMsgImm@".dtcm_ram";
//任务消息队列缓冲区,4字节对齐
#pragma pack(8)
uint32_t queueBufferAppTaskCanMsgImm[LENGTH_QUEUE_APP_TASK_CAN_MSG_IMM]@".dtcm_ram";
#pragma pack()
//任务消息队列控制块
TX_QUEUE queueAppTaskCanMsgImm@".dtcm_ram";
