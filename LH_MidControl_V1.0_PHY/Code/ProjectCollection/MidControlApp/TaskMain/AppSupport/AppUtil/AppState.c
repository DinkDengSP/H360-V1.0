...
void AppStateInit(APP_STATE* appStatePtr)
{
    ...
    //设置为默认值
    UserMemCopy((void*)&(appStatePtr->stModuleState[CAN_CELL_MODULE_1].deviceModuleState),(void*)&deviceModule1DefaultState,LENGTH_SYSTEM_MODULE_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleState[CAN_CELL_MODULE_2].deviceModuleState),(void*)&deviceModule2DefaultState,LENGTH_SYSTEM_MODULE_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleState[CAN_CELL_MODULE_3].deviceModuleState),(void*)&deviceModule3DefaultState,LENGTH_SYSTEM_MODULE_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleState[CAN_CELL_MODULE_4].deviceModuleState),(void*)&deviceModule4DefaultState,LENGTH_SYSTEM_MODULE_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleState[CAN_CELL_MODULE_5].deviceModuleState),(void*)&deviceModule5DefaultState,LENGTH_SYSTEM_MODULE_STATE);
    //设置模块状态更新时间
    ...
    //设置各个流程状态
    UserMemCopy((void*)&(appStatePtr->stModuleWorkingState[CAN_CELL_MODULE_1]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleWorkingState[CAN_CELL_MODULE_2]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleWorkingState[CAN_CELL_MODULE_3]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleWorkingState[CAN_CELL_MODULE_4]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleWorkingState[CAN_CELL_MODULE_5]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(appStatePtr->stModuleWorkingState[CAN_CELL_MODULE_PLATFORM]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
}
...
{
    UserMemCopy((void*)&(pstStatus->stModuleWorkingState[CAN_CELL_MODULE_1]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(pstStatus->stModuleWorkingState[CAN_CELL_MODULE_2]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(pstStatus->stModuleWorkingState[CAN_CELL_MODULE_3]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(pstStatus->stModuleWorkingState[CAN_CELL_MODULE_4]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(pstStatus->stModuleWorkingState[CAN_CELL_MODULE_5]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
    UserMemCopy((void*)&(pstStatus->stModuleWorkingState[CAN_CELL_MODULE_PLATFORM]),(void*)&stModuleWorkingStateDefault,LENGTH_APP_STATE_MODULE_WORKING_STATE);
}
