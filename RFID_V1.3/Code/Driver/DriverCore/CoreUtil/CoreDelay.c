...
**Author: DengXiaoJun
**Date: 2020-11-13 13:36:34
**LastEditors: DengXiaoJun
**LastEditTime: 2020-11-16 16:56:30
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
//微妙延时的最大限制
#define MAX_PARAM_US_DELAY		329000							   					
...
void CoreDelayInit(void)
{
	...
	//设置定时器中断优先级
	NVIC_SetPriority(SysTick_IRQn,INT_PRI_3);
    //SYSTICK使用外部时钟源
	...
	//reload为24位寄存器,最大值:16777216,在400M下,约合329ms左右	
	//代表OS可以延时的最少单位										
