 ...
 *Author: DengXiaoJun
 *Date: 2020-11-13 14:30:02
 *LastEditors: DengXiaoJun
 *LastEditTime: 2021-01-13 13:51:03
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
/**************************************CAN总线相关定义****************************************/
//CAN空闲队列
extern ADT_CIRCLE_CAN_RX_PTR_QUEUE canCirclePtrIdleQueue;

//总线接收缓存区长度
#define MCU_CAN_RECEIVE_BUFFER_LENGTH               8

//CAN口中断回调函数类型
typedef void (*MCU_CAN_RecvIntProcFuncPtr)(CanRxMsg* rxMsg);


extern uint8_t canBoardID;
