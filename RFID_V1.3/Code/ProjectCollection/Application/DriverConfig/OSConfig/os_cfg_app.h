 ...
 *Author: DengXiaoJun
 *Date: 2020-11-13 20:26:31
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-11-16 13:16:37
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
#define  OS_CFG_MSG_POOL_SIZE                             8u
...
#define  OS_CFG_STAT_TASK_RATE_HZ                           10u
                                                                /* Stack size (number of CPU_STK elements)              */
#define  OS_CFG_STAT_TASK_STK_SIZE                          64u
...
#define  OS_CFG_TMR_TASK_PRIO                               ((OS_PRIO)(OS_CFG_PRIO_MAX-3u))
                                                                /* Stack size (number of CPU_STK elements)              */
#define  OS_CFG_TMR_TASK_STK_SIZE                           64u
