 ...
 *Author: DengXiaoJun
 *Date: 2020-11-16 19:02:46
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-11-16 19:03:53
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
#define ADT_CIRCLE_BYTE_QUEUE_LOCK_THREAD()       ThreadLockInt()
//数据操作完成,打开中断,使多线程可以触发
#define ADT_CIRCLE_BYTE_QUEUE_UNLOCK_THREAD()     ThreadUnlockInt()
