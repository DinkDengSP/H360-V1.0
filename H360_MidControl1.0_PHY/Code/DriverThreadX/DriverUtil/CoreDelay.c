...
** Date          : 2022-09-15 09:11:03 +0800
** Description   : When I Has Time ,I Will Write Description Below:
** ModifyRecord1 :    
** ModifyRecord2 :    
** LastEditors   : DengXiaoJun(邓小俊)
** LastEditTime  : 2022-09-16 13:29:58 +0800
************************************************************************************************/ 
#include "CoreDelay.h"
#include "tx_api.h"
...
/*-----------------------------------------------使用定时器接口作为系统定时接口------------------------------------------*/
#if(CORE_DELAY_MODE_USER == CORE_DELAY_MODE_TIMER)
#include "MCU_Timer7.h"
//检查定时器设置
#if(MCU_TIMER7_MODE_USER != MCU_TIMER7_MODE_BASE)
#error "USE TIM7 Set CodeDelay,Time7Mode Need Set Mode MCU_TIMER7_MODE_BASE"
#endif
//单次延时最大微秒数
...
void CoreDelayInit(void)
{
    ...
    MCU_Timer7Init(19,60000,CoreDelayOverFlow);
    //初始化先停止计时器
    MCU_Timer7Stop();
}
...
/*-----------------------------------------------使用系统滴答定时器接口作为系统定时接口-----------------------------------*/
#if(CORE_DELAY_MODE_USER == CORE_DELAY_MODE_SYSTICK)
extern ULONG _tx_thread_system_state;
