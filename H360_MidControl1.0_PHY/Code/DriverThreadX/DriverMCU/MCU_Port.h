...
** Date          : 2022-09-15 09:12:11 +0800
** Description   : When I Has Time ,I Will Write Description Below:
** ModifyRecord1 :    
** ModifyRecord2 :    
** LastEditors   : DengXiaoJun(邓小俊)
** LastEditTime  : 2022-09-16 17:37:06 +0800
************************************************************************************************/ 
...
{
    PORT_STATE_INVALID    = 0X00,//端口无效
    PORT_STATE_VALID      = 0X01,//端口有效
}PORT_STATE;
...
//初始化指定引脚为中断引脚
void MCU_PortExtiInit(MCU_PIN pin,MCU_EXTI_MODE extiMode,MCU_PORT_PULL pullType,MCU_PORT_SPEED speed,
