...
** Date          : 2022-11-24 18:01:48 +0800
** Description   : When I Has Time ,I Will Write Description Below:
** ModifyRecord1 :    
** ModifyRecord2 :    
** LastEditors   : DengXiaoJun(邓小俊)
** LastEditTime  : 2022-11-25 10:05:17 +0800
************************************************************************************************/ 
#ifndef __MCU_UNIVERSAL_H_
#define __MCU_UNIVERSAL_H_
#include "CoreUtil.h"
#include "MCU_SPI_DriverConfig.h"

//内核时钟480MHZ
#if(CORE_CLOCK_MODE_USER == CORE_CLOCK_MODE_480M)
//SPI速度设定 PLL1Q 120M输入主频
typedef enum MCU_SPI_123_CLK
{
    SPI_123_BAUD_RATE_60M     = SPI_BAUDRATEPRESCALER_2,
    SPI_123_BAUD_RATE_30M     = SPI_BAUDRATEPRESCALER_4,
    SPI_123_BAUD_RATE_15M     = SPI_BAUDRATEPRESCALER_8,
    SPI_123_BAUD_RATE_7_5_M   = SPI_BAUDRATEPRESCALER_16,
    SPI_123_BAUD_RATE_3_75_M  = SPI_BAUDRATEPRESCALER_32,
    SPI_123_BAUD_RATE_1_875_M = SPI_BAUDRATEPRESCALER_64,
    SPI_123_BAUD_RATE_930K    = SPI_BAUDRATEPRESCALER_128,
    SPI_123_BAUD_RATE_468K    = SPI_BAUDRATEPRESCALER_256,
}MCU_SPI_123_CLK;

//SPI速度设定 APB2 120M输入主频
typedef enum MCU_SPI_45_CLK
{
    SPI_45_BAUD_RATE_60M      = SPI_BAUDRATEPRESCALER_2,
    SPI_45_BAUD_RATE_30M      = SPI_BAUDRATEPRESCALER_4,
    SPI_45_BAUD_RATE_15M      = SPI_BAUDRATEPRESCALER_8,
    SPI_45_BAUD_RATE_7_5_M    = SPI_BAUDRATEPRESCALER_16,
    SPI_45_BAUD_RATE_3_75_M   = SPI_BAUDRATEPRESCALER_32,
    SPI_45_BAUD_RATE_1_875_M  = SPI_BAUDRATEPRESCALER_64,
    SPI_45_BAUD_RATE_930K     = SPI_BAUDRATEPRESCALER_128,
    SPI_45_BAUD_RATE_468K     = SPI_BAUDRATEPRESCALER_256,
}MCU_SPI_45_CLK;

//SPI速度设定 APB4 120M输入主频
typedef enum MCU_SPI_6_CLK
{
    SPI_6_BAUD_RATE_60M      = SPI_BAUDRATEPRESCALER_2,
    SPI_6_BAUD_RATE_30M      = SPI_BAUDRATEPRESCALER_4,
    SPI_6_BAUD_RATE_15M      = SPI_BAUDRATEPRESCALER_8,
    SPI_6_BAUD_RATE_7_5_M    = SPI_BAUDRATEPRESCALER_16,
    SPI_6_BAUD_RATE_3_75_M   = SPI_BAUDRATEPRESCALER_32,
    SPI_6_BAUD_RATE_1_875_M  = SPI_BAUDRATEPRESCALER_64,
    SPI_6_BAUD_RATE_930K     = SPI_BAUDRATEPRESCALER_128,
    SPI_6_BAUD_RATE_468K     = SPI_BAUDRATEPRESCALER_256,
}MCU_SPI_6_CLK;
#endif

//内核时钟400MHZ
#if(CORE_CLOCK_MODE_USER == CORE_CLOCK_MODE_400M)
