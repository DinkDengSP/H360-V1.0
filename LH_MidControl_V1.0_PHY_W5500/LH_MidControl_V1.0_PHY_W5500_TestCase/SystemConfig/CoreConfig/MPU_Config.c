...
** Date          : 2022-10-27 18:07:23 +0800
** Description   : When I Has Time ,I Will Write Description Below:
** ModifyRecord1 :    
** ModifyRecord2 :    
** LastEditors   : DengXiaoJun(邓小俊)
** LastEditTime  : 2022-11-28 12:45:22 +0800
************************************************************************************************/ 
...
//Region6 SDRAM1的MPU配置,常规读写都开cache模式
...
//Region5 SDRAM2的MPU配置,常规读写都开cache模式
...
//MPU管理数组
MPU_REGION_CONFIG* mpuRegionConfigPtrArray[16] = {
