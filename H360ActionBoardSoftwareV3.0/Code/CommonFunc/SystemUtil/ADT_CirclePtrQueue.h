 ...
 *LastEditTime: 2020-05-14 17:37:04
 *FilePath: \H360_ActionBoard_ID_1d:\SVN_Local\02-Development\Software\H360_STM32\H360ActionBoardSoftwareV2.3\CommonFunc\SystemUtil\ADT_CirclePtrQueue.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
#define ADT_CIRCLE_BYTE_PTR_LOCK_THREAD()         CPU_IntDis()

//数据操作完成,打开中断,使多线程可以触发,非中断情况下
#define ADT_CIRCLE_BYTE_PTR_UNLOCK_THREAD()       CPU_IntEn()
