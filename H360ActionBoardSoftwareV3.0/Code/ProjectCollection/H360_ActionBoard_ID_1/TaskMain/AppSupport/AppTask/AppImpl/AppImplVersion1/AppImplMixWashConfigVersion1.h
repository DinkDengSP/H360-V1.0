 ...
 *Author: DengXiaoJun
 *Date: 2020-03-21 10:59:10
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-03-21 11:01:21
 *FilePath: \H360_ActionBoard_ID_1\TaskMain\AppSupport\AppTask\AppImpl\AppImplMixWashConfig.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
 *ModifyRecord5:    
******************************************************************/
#ifndef __APP_IMPL_MIX_WASH_CONFIG_VERSION_1_H_
#define __APP_IMPL_MIX_WASH_CONFIG_VERSION_1_H_
#include "AppImplBase.h"

//清洗混匀旋转电机编号
#define MIX_WASH_STEP_MOTOR_ROTATE_ID   STEP_MOTOR8
//清洗混匀升降电机编号
#define MIX_WASH_STEP_MOTOR_UPDOWN_ID   STEP_MOTOR7

//不同的摇匀模式对应的不同的旋转速度曲线
#define S_CURVE_MIX_WASH_ROTATE_DEBUG           SM_CURVE_0//清洗摇匀旋转调试曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_1_VERSION1          SM_CURVE_11//清洗摇匀模式1旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_2_VERSION1          SM_CURVE_12//清洗摇匀模式2旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_3_VERSION1          SM_CURVE_13//清洗摇匀模式3旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_4_VERSION1          SM_CURVE_14//清洗摇匀模式4旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_5_VERSION1          SM_CURVE_15//清洗摇匀模式5旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_6_VERSION1          SM_CURVE_16//清洗摇匀模式6旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_7_VERSION1          SM_CURVE_17//清洗摇匀模式7旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_8_VERSION1          SM_CURVE_18//清洗摇匀模式8旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_9_VERSION1          SM_CURVE_19//清洗摇匀模式9旋转曲线
#define S_CURVE_MIX_WASH_ROTATE_MODE_10_VERSION1         SM_CURVE_20//清洗摇匀模式10旋转曲线
