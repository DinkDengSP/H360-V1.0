...
**LastEditTime: 2020-12-16 19:23:55
...
**ModifyRecord5:    
******************************************************************/
#include "AppImplBufferInjectVersion1.h"
...
static LH_ERR AppImplBufferSolutionInjectResetModeRelease(void)
{
    ...
    //关闭V201
        AppLiquidUtilCloseValveV201Version1();
    //关闭V202
        AppLiquidUtilCloseValveV202Version1();
    //等待阀响应
...
static LH_ERR AppImplBufferSolutionInjectPrimeModeRelease(BOTTLE_BUFFER_SOLUTION bottltSelect)
{
    ...
    //根据参数选通AB瓶
        ...
        {
            AppLiquidUtilValveV201SelectBottle1Version1();
        }
        else
        {
            AppLiquidUtilValveV201SelectBottle2Version1();
        }
    //等待阀响应
        AppLiquidUtilWaitValveStableVersion1();
    //打开注液液路
        AppLiquidUtilOpenValveV202Version1();
    //等待阀响应
        AppLiquidUtilWaitValveStableVersion1();
    //注液一次走步数
