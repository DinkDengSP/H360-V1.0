...
**LastEditTime: 2020-12-16 16:23:14
...
static LH_ERR AppImplMixWashStartRotateMode1(void)
{
    ...
    //设置电机持续运转指令
        ...
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_1_VERSION0 ;
...
static LH_ERR AppImplMixWashStartRotateMode2(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_2_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode3(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_3_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode4(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_4_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode5(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_5_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode6(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_6_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode7(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_7_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode8(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_8_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode9(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_9_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashStartRotateMode10(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_WASH_ROTATE_MODE_10_VERSION0 ;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixWashRotateIntegratedMode1(void)
{
    ...
    //读取旋转复位修正
        AppParamRead(INDEX_CAN_SUB_BOARD1_PARAM_MAIN_MIX_WASH,APP_PARAM_SUB_INDEX_MIX_WASH_RESET_CORRECT_ROTATE,&paramUtil);
    //配置旋转复位修正结构体
        IPC_StepMotorUtilResetCmdDataStructInit(&resetCmd);
        resetCmd.motorIndex = MIX_WASH_STEP_MOTOR_ROTATE_ID;//电机序号
