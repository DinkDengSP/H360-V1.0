...
**Author: DengXiaoJun
**Date: 2020-02-11 13:29:06
**LastEditors: DengXiaoJun
**LastEditTime: 2020-03-06 09:29:03
**FilePath: \H360_ActionBoard_ID_1\TaskMain\AppSupport\AppTask\AppTaskParam.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
static const SYSTEM_TASK_CAN_MSG_PROC_UNIT AppTaskCanMsgProcFuncPtrArrayParam[] = {
    {AppTaskFuncParam_CanMsg_Proc_Read          ,2  ,"Read"         },
    {AppTaskFuncParam_CanMsg_Proc_Write         ,6  ,"Write"        },
    {AppTaskFuncParam_CanMsg_Proc_SetDefault    ,0  ,"SetDefault"   },
};
...
static LH_ERR AppTaskFuncParam_CanMsg_Proc_Read(void* canMsgCachePtr,uint8_t* detailDebugMsgPtr)
{
    ...
    INDEX_CAN_SUB_BOARD1_PARAM_MAIN mainIndex = (INDEX_CAN_SUB_BOARD1_PARAM_MAIN)(cachePtrLocal->recvCacheArray[4]);
...
static const SYSTEM_TASK_SELF_MSG_PROC_UNIT AppTaskSelfMsgProcFuncPtrArrayParam[] = {
    {AppTaskFuncParam_Self_Proc_SetDefault    ,"SetDefault" },
};
