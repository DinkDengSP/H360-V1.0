 ...
 *LastEditTime: 2020-02-13 15:12:10
 *FilePath: \H360ActionBoardSoftwareV2.3\ProjectCollection\H360_ActionBoard_StepMotor_Input_Output_Test\TaskMain\AppSupport\AppTask\AppImpl\AppImplBase.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
//APP LogicOther任务
extern const uint8_t* AppStepMotorDebugStartMsg;
extern const uint8_t* AppStepMotorDebugEndMsg;


extern const uint8_t* AppInOutDebugStartMsg;
extern const uint8_t* AppInOutDebugEndMsg;


extern const uint8_t* AppBarCodeScanDebugStartMsg;
extern const uint8_t* AppBarCodeScanDebugEndMsg;
