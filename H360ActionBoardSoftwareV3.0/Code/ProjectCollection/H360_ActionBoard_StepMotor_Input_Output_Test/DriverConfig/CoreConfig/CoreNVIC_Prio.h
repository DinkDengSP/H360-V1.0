 ...
 *Author: DengXiaoJun
 *Date: 2020-02-24 12:19:22
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-06-23 17:33:14
 *FilePath: \H360ActionBoardSoftwareV2.3\ProjectCollection\H360_ActionBoard_StepMotor_Input_Output_Test\DriverConfig\CoreConfig\CoreNVIC_Prio.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
...
//电机中断最高优先级
#define CPLD_EXT_INT_PORT2_PREE_PRI         INT_PRE_PRI_0
#define CPLD_EXT_INT_PORT2_SUB_PRI          INT_SUB_PRI_1

//编码器中断优先级
//定时器2 编码器1
#define MCU_TIMER2_INT_PREE_PRI             INT_PRE_PRI_0
#define MCU_TIMER2_INT_SUB_PRI              INT_SUB_PRI_3

//定时器5 编码器2
#define MCU_TIMER5_INT_PREE_PRI             INT_PRE_PRI_1
#define MCU_TIMER5_INT_SUB_PRI              INT_SUB_PRI_0

//中断抢占优先级,DMA 串口1
#define MCU_DMA2_STREAM7_PREE_PRI           INT_PRE_PRI_1
//中断子优先级
#define MCU_DMA2_STREAM7_SUB_PRI            INT_SUB_PRI_1

//中断抢占优先级,DMA 串口3
#define MCU_DMA1_STREAM3_PREE_PRI           INT_PRE_PRI_1
//中断子优先级
#define MCU_DMA1_STREAM3_SUB_PRI            INT_SUB_PRI_2
