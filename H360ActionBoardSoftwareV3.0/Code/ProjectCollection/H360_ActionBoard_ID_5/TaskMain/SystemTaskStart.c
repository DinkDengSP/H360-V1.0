...
static const OS_TASK_CREATE_CONFIG AppTaskArray[] = {
    {&tcbAppTaskNeedleSample, NAME_APP_TASK_NEEDLE_SAMPLE, AppTaskFuncNeedleSample, PRIO_APP_TASK_NEEDLE_SAMPLE, &stackBufferAppTaskNeedleSample[0],
        STK_SIZE_APP_TASK_NEEDLE_SAMPLE / 10, STK_SIZE_APP_TASK_NEEDLE_SAMPLE, 2},//
    {&tcbAppTaskHandNewCup, NAME_APP_TASK_HAND_NEW_CUP, AppTaskFuncHandNewCup, PRIO_APP_TASK_HAND_NEW_CUP, &stackBufferAppTaskHandNewCup[0],
        STK_SIZE_APP_TASK_HAND_NEW_CUP / 10, STK_SIZE_APP_TASK_HAND_NEW_CUP, 2},//
    {&tcbAppTaskSampleRackTrack, NAME_APP_TASK_SAMPLE_RACK_TRACK, AppTaskFuncSampleRackTrack, PRIO_APP_TASK_SAMPLE_RACK_TRACK, &stackBufferAppTaskSampleRackTrack[0],
        STK_SIZE_APP_TASK_SAMPLE_RACK_TRACK / 10, STK_SIZE_APP_TASK_SAMPLE_RACK_TRACK, 2},//
...
static void AppIPC_DataInit(void)
{
    IPC_HandNewCupDataInit();       //新杯机械手
    IPC_NeedleSampleDataInit();     //样本针
    IPC_AppParamDataInit();         //参数管理
    IPC_SampleRackTrackDataInit();  //样本架传送带
}
