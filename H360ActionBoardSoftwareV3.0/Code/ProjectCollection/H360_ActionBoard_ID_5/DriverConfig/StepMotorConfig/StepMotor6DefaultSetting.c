...
const STEP_MOTOR_ATTRIBUTE StepMotorDefaultAttriIndex6 = {
    ...
    //基础配置
    {
        BOARD_IN_MCU_ARM_SEN6_PE5,//BOARD_IN_PIN resetPinIndex;复位引脚
        ...
        2850,//uint32_t resetMaxSteps;复位最大步数
        -50,//int32_t reverseMaxSteps;反向最大行程
        2800,//int32_t positiveMaxSteps;正向最大行程
