...
static const OS_TASK_CREATE_CONFIG AppTaskArray[] = {
    {&tcbAppTaskHandWash, NAME_APP_TASK_HAND_WASH, AppTaskFuncHandWash, PRIO_APP_TASK_HAND_WASH, 
        &stackBufferAppTaskHandWash[0],STK_SIZE_APP_TASK_HAND_WASH / 10, STK_SIZE_APP_TASK_HAND_WASH,
        2},//清洗机械手任务
    {&tcbAppTaskMeasureUnit, NAME_APP_TASK_MEASURE_UNIT, AppTaskFuncMeasureUnit, PRIO_APP_TASK_MEASURE_UNIT, 
        &stackBufferAppTaskMeasureUnit[0],STK_SIZE_APP_TASK_MEASURE_UNIT / 10, STK_SIZE_APP_TASK_MEASURE_UNIT,
        2},//测量模块任务
    {&tcbAppTaskParam, NAME_APP_TASK_PARAM, AppTaskFuncParam, PRIO_APP_TASK_PARAM, 
        &stackBufferAppTaskParam[0],STK_SIZE_APP_TASK_PARAM / 10, STK_SIZE_APP_TASK_PARAM,
        2},//参数读写任务
};
//系统应用任务的数量,用于初始化
...
//    IPC_SerialDebugRS2DataInit();//调试串口
