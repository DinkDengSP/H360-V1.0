 ...
 *ModifyRecord5:    
******************************************************************/
#ifndef __APP_IMPL_MIX_REAGENT_CONFIG_VERSION0_H_
#define __APP_IMPL_MIX_REAGENT_CONFIG_VERSION0_H_
...
//试剂摇匀需要等待反应杯稳定延时时间
#define MIX_REAHENT_VERSION0_NEED_WAIT_CUP_STABLE_MS          700
//不同的摇匀模式对应的不同的旋转速度曲线
#define S_CURVE_MIX_REAGENT_ROTATE_DEBUG           SM_CURVE_0//试剂摇匀旋转调试曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_1_VERSION0          SM_CURVE_1//试剂摇匀模式1旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_2_VERSION0          SM_CURVE_2//试剂摇匀模式2旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_3_VERSION0          SM_CURVE_3//试剂摇匀模式3旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_4_VERSION0          SM_CURVE_4//试剂摇匀模式4旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_5_VERSION0          SM_CURVE_5//试剂摇匀模式5旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_6_VERSION0          SM_CURVE_6//试剂摇匀模式6旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_7_VERSION0          SM_CURVE_7//试剂摇匀模式7旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_8_VERSION0          SM_CURVE_8//试剂摇匀模式8旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_9_VERSION0          SM_CURVE_9//试剂摇匀模式9旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_10_VERSION0         SM_CURVE_10//试剂摇匀模式10旋转曲线
