 ...
 *ModifyRecord5:    
******************************************************************/
#ifndef __APP_IMPL_MIX_BEAD_CONFIG_H_
#define __APP_IMPL_MIX_BEAD_CONFIG_H_
...
#define S_CURVE_MIX_BEAD_ROTATE_MODE_1          SM_CURVE_1//磁珠摇匀模式1旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_2          SM_CURVE_2//磁珠摇匀模式2旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_3          SM_CURVE_3//磁珠摇匀模式3旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_4          SM_CURVE_4//磁珠摇匀模式4旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_5          SM_CURVE_5//磁珠摇匀模式5旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_6          SM_CURVE_6//磁珠摇匀模式6旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_7          SM_CURVE_7//磁珠摇匀模式7旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_8          SM_CURVE_8//磁珠摇匀模式8旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_9          SM_CURVE_9//磁珠摇匀模式9旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_10         SM_CURVE_10//磁珠摇匀模式10旋转曲线
