...
static LH_ERR AppImplMixBeadStartRotateMode1(void)
{
    ...
    //设置电机持续运转指令
        ...
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_1_VERSION1;
...
static LH_ERR AppImplMixBeadStartRotateMode2(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_2_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode3(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_3_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode4(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_4_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode5(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_5_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode6(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_6_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode7(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_7_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode8(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_8_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode9(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_9_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
static LH_ERR AppImplMixBeadStartRotateMode10(void)
{
    ...
    //设置电机持续运转指令
        IPC_StepMotorUtilRunAlwaysDataStructInit(&runAlwaysCmd);
        runAlwaysCmd.motorIndex = MIX_BEAD_STEP_MOTOR_ROTATE_ID;
        runAlwaysCmd.selectConfig = S_CURVE_MIX_BEAD_ROTATE_MODE_10_VERSION1;
        runAlwaysCmd.dir = BOARD_CPLD_MOTOR_DIR_CW;
    //电机开始持续运转
        errorCode = IPC_StepMotorRunAlwaysWhileReturn(&runAlwaysCmd);
        if(errorCode != LH_ERR_NONE)
...
LH_ERR AppImplMixBeadResetVersion1(void)
{
    ...
    //设置旋转电机为复位状态
        errorCode = IPC_StepMotorSetStateWhileReturn(MIX_BEAD_STEP_MOTOR_ROTATE_ID,STEP_MOTOR_MAIN_STATE_STOP,STEP_MOTOR_STOP_SUB_NORMAL);
        if(errorCode != LH_ERR_NONE)
        {
...
LH_ERR AppImplMixBeadRotateIntegratedVersion1(MIX_MODE mixMode)
{
    ...
    CoreDelayMsSensitivity(MIX_BEAD_VERSION1_NEED_WAIT_CUP_STABLE_MS);
    //调用实际的集成混匀的函数
...
LH_ERR AppImplMixBeadStepMotorResetVersion1(INDEX_MOTOR_MIX_BEAD index)
{
    ...
    //复位指令结构体
        ...
        IPC_StepMotorUtilResetCmdDataStructInit(&resetCmd);
    //旋转电机无原点，只设置电机状态。
    if(index == INDEX_MOTOR_MIX_BEAD_ROTATE)
    {
