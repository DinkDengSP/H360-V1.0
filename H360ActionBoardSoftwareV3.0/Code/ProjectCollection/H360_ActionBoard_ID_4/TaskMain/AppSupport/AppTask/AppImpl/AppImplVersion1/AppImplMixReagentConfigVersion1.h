 ...
 *Author: DengXiaoJun
 *Date: 2020-03-20 11:47:28
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-03-20 11:50:25
 *FilePath: \H360_ActionBoard_ID_4\TaskMain\AppSupport\AppTask\AppImpl\AppImplMixReagentConfig.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
 *ModifyRecord5:    
******************************************************************/
#ifndef __APP_IMPL_MIX_REAGENT_CONFIG_VERSION1_H_
#define __APP_IMPL_MIX_REAGENT_CONFIG_VERSION1_H_
#include "AppImplBase.h"


//试剂混匀旋转电机编号
#define MIX_REAGENT_STEP_MOTOR_ROTATE_ID   STEP_MOTOR4
//试剂混匀升降电机编号
#define MIX_REAGENT_STEP_MOTOR_UPDOWN_ID   STEP_MOTOR3

//试剂摇匀需要等待反应杯稳定延时时间
#define MIX_REAHENT_VERSION1_NEED_WAIT_CUP_STABLE_MS          700

//不同的摇匀模式对应的不同的旋转速度曲线
#define S_CURVE_MIX_REAGENT_ROTATE_DEBUG           SM_CURVE_0//试剂摇匀旋转调试曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_1_VERSION1          SM_CURVE_11//试剂摇匀模式1旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_2_VERSION1          SM_CURVE_12//试剂摇匀模式2旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_3_VERSION1          SM_CURVE_13//试剂摇匀模式3旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_4_VERSION1          SM_CURVE_14//试剂摇匀模式4旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_5_VERSION1          SM_CURVE_15//试剂摇匀模式5旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_6_VERSION1          SM_CURVE_16//试剂摇匀模式6旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_7_VERSION1          SM_CURVE_17//试剂摇匀模式7旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_8_VERSION1          SM_CURVE_18//试剂摇匀模式8旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_9_VERSION1          SM_CURVE_19//试剂摇匀模式9旋转曲线
#define S_CURVE_MIX_REAGENT_ROTATE_MODE_10_VERSION1         SM_CURVE_20//试剂摇匀模式10旋转曲线
