 ...
 *ModifyRecord5:    
******************************************************************/
#ifndef __APP_IMPL_MIX_BEAD_CONFIG_VERSION0_H_
#define __APP_IMPL_MIX_BEAD_CONFIG_VERSION0_H_
...
//磁珠摇匀需要等待反应杯稳定延时时间
#define MIX_BEAD_VERSION0_NEED_WAIT_CUP_STABLE_MS          700
//不同的摇匀模式对应的不同的旋转速度曲线
#define S_CURVE_MIX_BEAD_ROTATE_DEBUG           SM_CURVE_0//磁珠摇匀旋转调试曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_1_VERSION0          SM_CURVE_1//磁珠摇匀模式1旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_2_VERSION0          SM_CURVE_2//磁珠摇匀模式2旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_3_VERSION0          SM_CURVE_3//磁珠摇匀模式3旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_4_VERSION0          SM_CURVE_4//磁珠摇匀模式4旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_5_VERSION0          SM_CURVE_5//磁珠摇匀模式5旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_6_VERSION0          SM_CURVE_6//磁珠摇匀模式6旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_7_VERSION0          SM_CURVE_7//磁珠摇匀模式7旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_8_VERSION0          SM_CURVE_8//磁珠摇匀模式8旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_9_VERSION0          SM_CURVE_9//磁珠摇匀模式9旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_10_VERSION0         SM_CURVE_10//磁珠摇匀模式10旋转曲线
