 ...
 *Author: DengXiaoJun
 *Date: 2020-03-19 15:12:28
 *LastEditors: DengXiaoJun
 *LastEditTime: 2020-03-19 18:19:48
 *FilePath: \H360_ActionBoard_ID_4\TaskMain\AppSupport\AppTask\AppImpl\AppImplMixBeadConfig.h
 *ModifyRecord1:    
 *ModifyRecord2:    
 *ModifyRecord3:    
 *ModifyRecord4:    
 *ModifyRecord5:    
******************************************************************/
#ifndef __APP_IMPL_MIX_BEAD_CONFIG_VERSION1_H_
#define __APP_IMPL_MIX_BEAD_CONFIG_VERSION1_H_
#include "AppImplBase.h"

//磁珠混匀旋转电机编号
#define MIX_BEAD_STEP_MOTOR_ROTATE_ID   STEP_MOTOR6
//磁珠混匀升降电机编号
#define MIX_BEAD_STEP_MOTOR_UPDOWN_ID   STEP_MOTOR5

//磁珠摇匀需要等待反应杯稳定延时时间
#define MIX_BEAD_VERSION1_NEED_WAIT_CUP_STABLE_MS          700

//不同的摇匀模式对应的不同的旋转速度曲线
#define S_CURVE_MIX_BEAD_ROTATE_DEBUG           SM_CURVE_0//磁珠摇匀旋转调试曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_1_VERSION1           SM_CURVE_11//磁珠摇匀模式1旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_2_VERSION1           SM_CURVE_12//磁珠摇匀模式2旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_3_VERSION1           SM_CURVE_13//磁珠摇匀模式3旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_4_VERSION1           SM_CURVE_14//磁珠摇匀模式4旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_5_VERSION1           SM_CURVE_15//磁珠摇匀模式5旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_6_VERSION1           SM_CURVE_16//磁珠摇匀模式6旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_7_VERSION1           SM_CURVE_17//磁珠摇匀模式7旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_8_VERSION1           SM_CURVE_18//磁珠摇匀模式8旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_9_VERSION1           SM_CURVE_19//磁珠摇匀模式9旋转曲线
#define S_CURVE_MIX_BEAD_ROTATE_MODE_10_VERSION1          SM_CURVE_20//磁珠摇匀模式10旋转曲线
