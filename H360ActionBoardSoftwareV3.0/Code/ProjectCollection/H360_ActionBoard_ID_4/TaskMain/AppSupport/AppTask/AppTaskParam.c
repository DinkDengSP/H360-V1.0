...
**Author: DengXiaoJun
**Date: 2020-02-11 14:44:06
**LastEditors: DengXiaoJun
**LastEditTime: 2020-03-12 16:03:11
**FilePath: \H360_ActionBoard_ID_4\TaskMain\AppSupport\AppTask\AppTaskParam.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
static LH_ERR AppTaskFuncParam_CanMsg_Proc_Read(void* canMsgCachePtr,uint8_t* detailDebugMsgPtr)
{
    ...
    INDEX_CAN_SUB_BOARD4_PARAM_MAIN mainIndex = (INDEX_CAN_SUB_BOARD4_PARAM_MAIN)(cachePtrLocal->recvCacheArray[4]);
