...
**Author: DengXiaoJun
**Date: 2020-02-11 15:07:25
**LastEditors: DengXiaoJun
**LastEditTime: 2020-03-12 13:52:00
**FilePath: \H360_ActionBoard_ID_4\TaskMain\AppSupport\AppIpc\AppIpcPlateReaction.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
**ModifyRecord5:    
******************************************************************/
#include "AppIpcPlateReaction.h"
#include "AppTaskConfig.h"

//通道指令
typedef enum IPC_CMD_PLATE_REACTION
{
    IPC_CMD_PLATE_REACTION_RESET                    = 0X0000,//反应盘复位
    IPC_CMD_PLATE_REACTION_RUN_TO_CUP_POSITIVE      = 0X0001,//反应盘正向运转到指定序号杯位
    IPC_CMD_PLATE_REACTION_RUN_ANY_CUPS_POSITIVE    = 0X0002,//反应盘正向旋转指定数量杯位
    IPC_CMD_PLATE_REACTION_RUN_TO_CUP_NEGATIVE      = 0X0003,//反应盘反向运转到指定序号杯位
    IPC_CMD_PLATE_REACTION_RUN_ANY_CUPS_NEGATIVE    = 0X0004,//反应盘反向旋转指定数量杯位
}IPC_CMD_PLATE_REACTION;

//IPC调用的数据结构
static DATA_IPC_PLATE_REACTION dataIPC_PlateReaction;
//互斥信号量,用于API的互斥访问
...
LH_ERR IPC_PlateReactionWaitLastReturn(void)
{
    ...
    do
    {
        ipcState = IPC_PlateReactionGetLastCommandStatusAndResult(&errorCode);
...
/****************************************************内部向任务发送消息的API*******************************************************/
//动作API发送任务给动作API
static LH_ERR IPC_PlateReactionSendCommandWhileAck(uint16_t cmdIndex,int32_t param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5)
{
    OS_ERR err;
    //系统消息指针
    ...
    //将申请的指针传递给对应的任务信道做处理
    OSTaskQPost((OS_TCB *)&tcbAppTaskPlateReaction, //向协议处理线程发送消息
                        (void *)systemTaskCmd,
...
{
    return IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RESET,((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
}

//反应盘正向运转到指定序号杯位,不等待完成
LH_ERR IPC_PlateReactionRunToCupWithIndexPositiveWhileAck(uint8_t targetCup)
{
    return IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_TO_CUP_POSITIVE,((int32_t)0),((int32_t)targetCup),((int32_t)0),((int32_t)0),((int32_t)0));
}

//反应盘正向旋转指定数量杯位,不等待完成
LH_ERR IPC_PlateReactionRunAnyCupsPositiveWhileAck(uint8_t cups)
{
    return IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_ANY_CUPS_POSITIVE,((int32_t)cups),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
}

//反应盘反向运转到指定序号杯位,不等待完成
LH_ERR IPC_PlateReactionRunToCupWithIndexNegativeWhileAck(uint8_t targetCup)
{
    return IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_TO_CUP_NEGATIVE,((int32_t)targetCup),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
}

//反应盘反向旋转指定数量杯位,不等待完成
LH_ERR IPC_PlateReactionRunAnyCupsNegativeWhileAck(uint8_t cups)
{
    return IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_ANY_CUPS_NEGATIVE,((int32_t)cups),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
}
...
LH_ERR IPC_PlateReactionResetWhileReturn(void)
{
    LH_ERR errorCode = LH_ERR_NONE;
    //首先发出指令
    errorCode = IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RESET,((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
    if(errorCode != LH_ERR_NONE)
    {
        return errorCode;
    }
    //等待指令完成
    errorCode = IPC_PlateReactionWaitLastReturn();
    if(errorCode != LH_ERR_NONE)
    {
        return errorCode;
    }
...
LH_ERR IPC_PlateReactionRunToCupWithIndexPositiveWhileReturn(uint8_t targetCup)
{
    LH_ERR errorCode = LH_ERR_NONE;
    //首先发出指令
    errorCode = IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_TO_CUP_POSITIVE,((int32_t)targetCup),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
    if(errorCode != LH_ERR_NONE)
    {
        return errorCode;
    }
...
LH_ERR IPC_PlateReactionRunAnyCupsPositiveWhileReturn(uint8_t cups)
{
    LH_ERR errorCode = LH_ERR_NONE;
    //首先发出指令
    errorCode = IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_ANY_CUPS_POSITIVE,((int32_t)cups),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
    if(errorCode != LH_ERR_NONE)
    {
        return errorCode;
    }
...
LH_ERR IPC_PlateReactionRunToCupWithIndexNegativeWhileReturn(uint8_t targetCup)
{
    LH_ERR errorCode = LH_ERR_NONE;
    //首先发出指令
    errorCode = IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_TO_CUP_NEGATIVE,((int32_t)targetCup),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
    if(errorCode != LH_ERR_NONE)
    {
        return errorCode;
    }
...
LH_ERR IPC_PlateReactionRunAnyCupsNegativeWhileReturn(uint8_t cups)
{
    LH_ERR errorCode = LH_ERR_NONE;
    //首先发出指令
    errorCode = IPC_PlateReactionSendCommandWhileAck(IPC_CMD_PLATE_REACTION_RUN_ANY_CUPS_NEGATIVE,((int32_t)cups),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
    if(errorCode != LH_ERR_NONE)
    {
        return errorCode;
    }
