...
**Author: DengXiaoJun
**Date: 2020-02-11 15:07:59
**LastEditors: DengXiaoJun
**LastEditTime: 2020-03-12 13:49:17
**FilePath: \H360_ActionBoard_ID_4\TaskMain\AppSupport\AppIpc\AppIpcParam.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
{
    IPC_CMD_APP_PARAM_SET_DEFAULT = 0X0000,//初始化板上参数为默认值
}IPC_CMD_APP_PARAM;
...
{
    return IPC_AppParamSendCommandWhileAck(IPC_CMD_APP_PARAM_SET_DEFAULT,((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
}
...
LH_ERR IPC_AppParamSetDefaultWhileReturn(void)
{
    LH_ERR errorCode = LH_ERR_NONE;
    //首先发出指令
    errorCode = IPC_AppParamSendCommandWhileAck(IPC_CMD_APP_PARAM_SET_DEFAULT,((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0),((int32_t)0));
