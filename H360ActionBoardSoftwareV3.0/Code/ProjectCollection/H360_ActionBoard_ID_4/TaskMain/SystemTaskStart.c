...
static const OS_TASK_CREATE_CONFIG AppTaskArray[] = {
    {&tcbAppTaskNeedleReagent, NAME_APP_TASK_NEEDLE_REAGENT, AppTaskFuncNeedleReagent, PRIO_APP_TASK_NEEDLE_REAGENT, &stackBufferAppTaskNeedleReagent[0],
        STK_SIZE_APP_TASK_NEEDLE_REAGENT / 10, STK_SIZE_APP_TASK_NEEDLE_REAGENT,2},//
    {&tcbAppTaskPlateReaction, NAME_APP_TASK_PLATE_REACTION, AppTaskFuncPlateReaction, PRIO_APP_TASK_PLATE_REACTION, &stackBufferAppTaskPlateReaction[0],
        STK_SIZE_APP_TASK_PLATE_REACTION / 10, STK_SIZE_APP_TASK_PLATE_REACTION,2},//
    {&tcbAppTaskMixBead, NAME_APP_TASK_MIX_BEAD, AppTaskFuncMixBead, PRIO_APP_TASK_MIX_BEAD, &stackBufferAppTaskMixBead[0],
        STK_SIZE_APP_TASK_MIX_BEAD / 10, STK_SIZE_APP_TASK_MIX_BEAD,2},//
    {&tcbAppTaskMixReagent, NAME_APP_TASK_MIX_REAGENT, AppTaskFuncMixReagent, PRIO_APP_TASK_MIX_REAGENT, &stackBufferAppTaskMixReagent[0],
        STK_SIZE_APP_TASK_MIX_REAGENT / 10, STK_SIZE_APP_TASK_MIX_REAGENT,2},//
    {&tcbAppTaskParam, NAME_APP_TASK_PARAM, AppTaskFuncParam, PRIO_APP_TASK_PARAM, &stackBufferAppTaskParam[0],
        STK_SIZE_APP_TASK_PARAM / 10, STK_SIZE_APP_TASK_PARAM,2},//
};
//系统应用任务的数量,用于初始化
...
static void AppIPC_DataInit(void)
{
    IPC_MixBeadDataInit();          //磁珠混匀
    IPC_MixReagentDataInit();       //试剂混匀
    IPC_NeedleReagentDataInit();    //试剂针
    IPC_AppParamDataInit();         //参数管理
    IPC_PlateReactionDataInit();    //反应盘
}
