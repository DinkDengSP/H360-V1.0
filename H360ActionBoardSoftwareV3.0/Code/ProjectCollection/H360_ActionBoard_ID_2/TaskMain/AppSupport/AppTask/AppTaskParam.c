...
**Author: DengXiaoJun
**Date: 2020-02-11 14:06:52
**LastEditors: DengXiaoJun
**LastEditTime: 2020-03-18 16:47:00
**FilePath: \H360ActionBoardSoftwareV2.3\ProjectCollection\H360_ActionBoard_ID_2\TaskMain\AppSupport\AppTask\AppTaskParam.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
static LH_ERR AppTaskFuncParam_CanMsg_Proc_Read(void* canMsgCachePtr,uint8_t* detailDebugMsgPtr)
{
    ...
    INDEX_CAN_SUB_BOARD2_PARAM_MAIN mainIndex = (INDEX_CAN_SUB_BOARD2_PARAM_MAIN)(cachePtrLocal->recvCacheArray[4]);
...
/************************************************自身分层API调用的消息的处理**********************************/
//初始化板上参数为默认值
static LH_ERR AppTaskFuncParam_Self_Proc_SetDefault(SYSTEM_CMD_SELF* selfCmdPtr,uint8_t* detailDebugMsgPtr);
