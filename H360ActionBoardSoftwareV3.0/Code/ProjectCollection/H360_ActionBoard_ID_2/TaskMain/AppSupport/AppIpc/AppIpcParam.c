...
**Author: DengXiaoJun
**Date: 2020-02-11 14:15:11
**LastEditors: DengXiaoJun
**LastEditTime: 2020-03-10 18:56:09
**FilePath: \H360_ActionBoard_ID_2\TaskMain\AppSupport\AppIpc\AppIpcParam.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
{
    IPC_CMD_APP_PARAM_SET_DEFAULT   = 0x00,//系统参数复位                 
}IPC_CMD_APP_PARAM;
