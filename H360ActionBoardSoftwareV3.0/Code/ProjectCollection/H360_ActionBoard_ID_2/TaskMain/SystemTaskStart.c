...
static const OS_TASK_CREATE_CONFIG AppTaskArray[] = {
    {&tcbAppTaskCupTrayManage, NAME_APP_TASK_CUP_TRAY_MANAGE, AppTaskFuncCupTrayManage, PRIO_APP_TASK_CUP_TRAY_MANAGE, &stackBufferAppTaskCupTrayManage[0],
        STK_SIZE_APP_TASK_CUP_TRAY_MANAGE / 10, STK_SIZE_APP_TASK_CUP_TRAY_MANAGE, 2},//杯栈管理
    {&tcbAppTaskNeedleBead, NAME_APP_TASK_NEEDLE_BEAD, AppTaskFuncNeedleBead, PRIO_APP_TASK_NEEDLE_BEAD, &stackBufferAppTaskNeedleBead[0],
        STK_SIZE_APP_TASK_NEEDLE_BEAD / 10, STK_SIZE_APP_TASK_NEEDLE_BEAD, 2},//磁珠针
    {&tcbAppTaskParam, NAME_APP_TASK_PARAM, AppTaskFuncParam, PRIO_APP_TASK_PARAM, &stackBufferAppTaskParam[0],
        STK_SIZE_APP_TASK_PARAM / 10, STK_SIZE_APP_TASK_PARAM, 2},//应用参数
    {&tcbAppTaskPlateReagent, NAME_APP_TASK_PLATE_REAGENT, AppTaskFuncPlateReagent, PRIO_APP_TASK_PLATE_REAGENT, &stackBufferAppTaskPlateReagent[0],
        STK_SIZE_APP_TASK_PLATE_REAGENT / 10, STK_SIZE_APP_TASK_PLATE_REAGENT, 2},//试剂盘
};
//系统应用任务的数量,用于初始化
...
static void AppIPC_DataInit(void)
{
    IPC_CupTrayManageDataInit();    //杯栈管理
    IPC_NeedleBeadDataInit();       //磁珠针
    IPC_AppParamDataInit();         //参数管理
    IPC_PlateReagentDataInit();     //试剂盘
}
