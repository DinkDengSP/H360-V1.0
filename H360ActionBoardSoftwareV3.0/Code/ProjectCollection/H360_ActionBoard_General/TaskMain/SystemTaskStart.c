...
static const OS_TASK_CREATE_CONFIG AppTaskArray[] = {
    {&tcbAppTaskOther, NAME_APP_TASK_OTHER, AppTaskFuncOther, 
        PRIO_APP_TASK_OTHER, &stackBufferAppTaskOther[0],
        STK_SIZE_APP_TASK_OTHER / 10, STK_SIZE_APP_TASK_OTHER, 
        1},//应用的其他任务
};
//系统应用任务的数量,用于初始化
