...
const STEP_MOTOR_ATTRIBUTE StepMotorDefaultAttriIndex7 = {
    ...
    //基础配置
    {
        BOARD_IN_MCU_ARM_SEN16_PB7,//BOARD_IN_PIN resetPinIndex;复位引脚
        ...
        20000,//uint32_t resetMaxSteps;复位最大步数
        -1000,//int32_t reverseMaxSteps;反向最大行程
        19000,//int32_t positiveMaxSteps;正向最大行程
