...
**LastEditTime: 2020-02-13 13:25:04
**FilePath: \H360ActionBoardSoftwareV2.3\ProjectCollection\H360_ActionBoard_ID_8_Rail\TaskMain\AppLogicSupport\AppIpc\AppIpcParam.c
**ModifyRecord1:    
**ModifyRecord2:    
**ModifyRecord3:    
**ModifyRecord4:    
...
//指令列表
typedef enum IPC_CMD_PARAM
{
    IPC_CMD_PARAM_RESET_DEFAULT = 0X0000,
}IPC_CMD_PARAM;
...
{
    return IPC_AppParamSendCommandWhileAck(IPC_CMD_PARAM_RESET_DEFAULT,0,0,0,0,0);
}
...
LH_ERR IPC_AppParamResetDefaultWhileReturn(void)
{
    LH_ERR errorCode = LH_ERR_NONE;
    STATE_IPC ipcState = STATE_IPC_WAIT_RETURN;
    errorCode = IPC_AppParamSendCommandWhileAck(IPC_CMD_PARAM_RESET_DEFAULT,0,0,0,0,0);
