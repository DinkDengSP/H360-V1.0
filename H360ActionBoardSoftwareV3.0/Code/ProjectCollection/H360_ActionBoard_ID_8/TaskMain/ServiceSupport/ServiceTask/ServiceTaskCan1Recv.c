...
static const CAN_SLAVE_DISPATCH_CONFIG canSlaveDispatchConfigArray[CAN_PROTOCOL_BOARD_CHANNEL_MAX] = {
    ...
    {19 ,   &tcbAppTaskPushIn1              },
    {20 ,   &tcbAppTaskPushIn2              },
    {21 ,   &tcbAppTaskPushOut1             },
    {22 ,   &tcbAppTaskPushOut2             },
    {23 ,   &tcbAppTaskRailTrans            },
    {24 ,   &tcbAppTaskRailHand             },
    {25 ,   &tcbAppTaskRailComplex          },
    {26 ,   &tcbAppTaskBarScan              },
    {27 ,   &tcbAppTaskParam                },
    {28 ,   NULL},
    {29 ,   NULL},
    {30 ,   NULL},
