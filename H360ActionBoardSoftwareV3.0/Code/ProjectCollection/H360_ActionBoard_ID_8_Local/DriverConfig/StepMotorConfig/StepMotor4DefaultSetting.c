...
const STEP_MOTOR_ATTRIBUTE StepMotorDefaultAttriIndex4 = {
    ...
    //基础配置
    {
        BOARD_IN_MCU_SLAVE_ARM_SEN15_PB0,//BOARD_IN_PIN resetPinIndex;复位引脚
        ...
        19000,//uint32_t resetMaxSteps;复位最大步数
        -2000,//int32_t reverseMaxSteps;反向最大行程
        17000,//int32_t positiveMaxSteps;正向最大行程
