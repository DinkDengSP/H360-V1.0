...
static const CAN_SLAVE_DISPATCH_CONFIG canSlaveDispatchConfigArray[CAN_PROTOCOL_BOARD_CHANNEL_MAX] = {
    ...
    {19 ,   &tcbAppTaskRackStoreIn            },
    {20 ,   &tcbAppTaskRackEntry              },
    {21 ,   &tcbAppTaskRackBarScan            },
    {22 ,   &tcbAppTaskRackTest               },
    {23 ,   &tcbAppTaskRackInSwitch           },
    {24 ,   &tcbAppTaskRackWaitOut1           },
    {25 ,   &tcbAppTaskRackWaitOut2           },
    {26 ,   &tcbAppTaskRackOutSwitch          },
    {27 ,   &tcbAppTaskRackStoreOut           },
    {28 ,   &tcbAppTaskParamUtil              },
    {29 ,   NULL                              },
    {30 ,   NULL                              },
    {31 ,   NULL                              },
};
